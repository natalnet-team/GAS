...
O GAS é um grupo irmão do [GIM](https://github.com/lar-ect/gim), são grupo complementares dentro da UFRN.
...
REPOSITORIO PRINCIPAL: [repositório do GAS](https://github.com/natalnet-gas)
